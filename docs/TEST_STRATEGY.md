...
| Total tests | 1,124 | Good — comprehensive for core + all 17 languages + schema evolution |
...
- **Steps:**
  ...
  4. `:plugin:test` (all 1,124 unit tests)
  5. Install protoc
...
|------|----------|-------------|
| All tests pass | 100% pass rate (1,124/1,124) | CI: `./gradlew :plugin:test` |
