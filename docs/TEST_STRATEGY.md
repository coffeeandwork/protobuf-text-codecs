...
| Total tests | 1,107 | Good — comprehensive for core + all 17 languages + schema evolution |
...
- **Steps:**
  ...
  4. `:plugin:test` (all 1,107 unit tests)
  5. Install protoc
...
|------|----------|-------------|
| All tests pass | 100% pass rate (1,107/1,107) | CI: `./gradlew :plugin:test` |
