...
public class SwiftGenerator implements LanguageGenerator {
  ...
  private final SwiftCodeEmitter codeEmitter = new SwiftCodeEmitter(typeMapper, nameResolver);
  ...
  public List<CodeGeneratorResponse.File> generate(ProtoFile file, TypeRegistry registry) {
    ...
    // Generate a Swift file for each top-level message
    ...
    // Generate a Swift file for each top-level enum
